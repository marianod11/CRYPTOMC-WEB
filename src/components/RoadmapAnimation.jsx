...
export default function RoadmapAnimation() {
    ...
    const Popbox2 = () => (
        <OverlayTrigger trigger="click" rootClose placement="right" overlay={popover2}>
            <div className='container cajitaRoadmap' id='RoadBox2-xs'>
                <div className='row'>
                    <div className='col-5'>
                        <img src={closeBox} alt="" />
                    </div>
    ...
    const Popbox3 = () => (
        <OverlayTrigger trigger="click" rootClose placement="bottom" overlay={popover3}>
    ...
    const Popbox4 = () => (
        <OverlayTrigger trigger="click" rootClose placement="left" overlay={popover4}>
            <div className='container cajitaRoadmap' id='RoadBox4-xs'>
                <div className='row'>
                    <div className='col-5'>
                        <img src={closeBox} alt="" />
                    </div>
